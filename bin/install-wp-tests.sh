#!/usr/bin/env bash
# Canonical WP scaffold installer for the PHPUnit test suite.
# Usage:
...
install_test_suite() {
	# Portable in-place argument for both GNU sed and BSD/macOS sed.
...
install_db() {
	...
	# Parse DB_HOST for socket / port references.
	local PARTS=(${DB_HOST//\:/ })
